...
public:
    ...
    virtual bool HasDiffuseReflection() const override;
    virtual bool HasSpecularReflection() const override;

    virtual glm::vec3 GetBaseDiffuseReflection() const override;
    virtual glm::vec3 GetBaseSpecularReflection() const override;
protected:
